"""
Django settings for AhsansDevSite project.
...
ALLOWED_HOSTS = ["127.0.0.1",".herokuapp.com",".thisisahsan.com","ahsan.is-a.dev"]
...
ROOT_URLCONF = 'AhsansDevSite.urls'
...
WSGI_APPLICATION = 'AhsansDevSite.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'mainSite/static')
STATIC_URL = '/static/'
